...
# %%
TEST_WITH_REF = True # NOTE: toggle this flag to `True` to enable testing with running the cells with ref
# TEST_WITH_REF = True
...
system_prompt_str = system_prompt_template(subject=subject, adjective=adjective)
context_prompt_str = context_prompt_template(subject=subject, adjective=adjective)
